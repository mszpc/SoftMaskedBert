...
if [[ $# -lt 3 || $# -gt 4 ]]; then
    ...
    Example: bash scripts/run_infer_310.sh ./mindir/atis_intent.mindir ./data/atis_intent/atis_intent_test.mindrecord y 0"
exit 1
fi
