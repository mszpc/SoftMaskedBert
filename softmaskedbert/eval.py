...
def run_csc():
    ...
    parser.add_argument("--data_url", type=str, default="./datasets/csc/dev.json")  # direction of the training dataset, such as s3://open-data/attachment/1/4/1493e5f0-4601-408e-bc7f-b51ef8b3785c1493e5f0-4601-408e-bc7f-b51ef8b3785c/
